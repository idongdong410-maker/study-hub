...
각 강마다:
1. 지문 요약/분석 카드 1개 (주제, 핵심 논지, 주요 어휘)
2. 해당 강 유형에 맞는 문제 1개
...
반드시 아래 JSON 형식으로만 출력해:
{
  ...
  "cards": [
    {"id":"eng-card-{오늘날짜}-NUM","deck":"engsum","front":"{강번호} / 지문 제목 또는 주제","back":"요약: ...\n핵심 논지: ...\n주요 어휘: ...","tag":"{강번호}강"}
  ],
  "concepts": [
    {"id":"concept-eng-{오늘날짜}","subject":"english","topic":"수능특강 독해","content":"## 오늘의 지문 요약\n각 지문의 주제와 핵심 논지\n\n## 핵심 어휘\n오늘 등장한 고난도 어휘 목록\n\n## 독해 포인트\n각 유형별 풀이 전략","date":"{오늘날짜}"}
  ]
}
